...
const Filter = ({
  ...
  const { searchName, address } = filter
  ...
  return (
    <Row gutter={24}>
      <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
        {getFieldDecorator('searchName', { initialValue: searchName })(<Search placeholder="搜索店铺名称" size="large" onSearch={handleSubmit} />)}
      </Col>
      {/*<Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
      ...
      <Col {...TwoColProps} xl={{ span: 4 }} md={{ span: 8 }} sm={{ span: 8 }}>
        <Button size="large" type="ghost" onClick={onAdd}>添加店铺</Button>
