 ...
 */
public class ToggleMainAdapter extends RecyclerView.Adapter<ToggleMainAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public ToggleMainAdapter(List<ToggleBean> datas, Context context) {
        this.datas = datas;
