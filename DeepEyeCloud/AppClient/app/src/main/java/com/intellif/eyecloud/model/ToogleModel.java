 ...
 */
public class ToogleModel implements IToogleContact.IToogleModel {
    @Override
    public void getArea(int userId, final OnHttpCallBack<List<ToggleBean>> callBack) {
        ...
        RequestParams params = new RequestParams(UrlConfig.QueryArea);
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if(errCode==0){
                    Gson gson = new Gson();
                    List<ToggleBean> mlist =gson.fromJson(data,new TypeToken<List<ToggleBean>>(){}.getType());
    ...
    @Override
    public void getTopic(int page, int pageSize, String areaId, final OnHttpCallBack<List<ManageBean>> callBack) {
        JSONObject object = new JSONObject();
        try {
            object.put("ids","");
            object.put("searchName","");
