...
public class RecordDetailModel implements IRecordDetailContact.IRecordDetailModel {

    @Override
    public void sendToServer(int id, final OnHttpCallBack<DeleteBean> callBack) {
...
//        }
        ...
        RequestParams params = new RequestParams(UrlConfig.DeleteAlarm+id);
        ...
        x.http().request(HttpMethod.DELETE,params,new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if(errCode==0){
                        Gson gson = new Gson();
                        DeleteBean mlist =gson.fromJson(data,new TypeToken<DeleteBean>(){}.getType());
