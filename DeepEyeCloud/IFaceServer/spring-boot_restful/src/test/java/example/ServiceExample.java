...
public class ServiceExample {
  ...
  public interface AsyncIface {
    ...
    public void getBean(int anArg, String anOther, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getBean_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public getBean_call(int anArg, String anOther, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getBean<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getBean_args, BeanExample> {
      ...
      public AsyncMethodCallback<BeanExample> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<BeanExample>() { 
      ...
      public void start(I iface, getBean_args args, org.apache.thrift.async.AsyncMethodCallback<BeanExample> resultHandler) throws TException {
  ...
  public static class getBean_args implements org.apache.thrift.TBase<getBean_args, getBean_args._Fields>, java.io.Serializable, Cloneable, Comparable<getBean_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_anArg = true;
      list.add(present_anArg);
      if (present_anArg)
        list.add(anArg);

      boolean present_anOther = true && (isSetAnOther());
      list.add(present_anOther);
      if (present_anOther)
        list.add(anOther);
    ...
    public int compareTo(getBean_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetAnArg()).compareTo(other.isSetAnArg());
      if (lastComparison != 0) {
      ...
      lastComparison = Boolean.valueOf(isSetAnOther()).compareTo(other.isSetAnOther());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetAnOther()) {
