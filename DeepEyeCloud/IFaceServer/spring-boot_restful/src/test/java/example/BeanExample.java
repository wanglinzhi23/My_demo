...
public class BeanExample implements org.apache.thrift.TBase<BeanExample, BeanExample._Fields>, java.io.Serializable, Cloneable, Comparable<BeanExample> {
  ...
  public BeanExample setByteArray(byte[] byteArray) {
    this.byteArray = byteArray == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(byteArray, byteArray.length));
    return this;
  }
  ...
  public int hashCode() {
    ...
    boolean present_booleanPrimive = true;
    list.add(present_booleanPrimive);
    if (present_booleanPrimive)
      list.add(booleanPrimive);

    boolean present_bytePrimive = true;
    list.add(present_bytePrimive);
    if (present_bytePrimive)
      list.add(bytePrimive);

    boolean present_shortPrimive = true;
    list.add(present_shortPrimive);
    if (present_shortPrimive)
      list.add(shortPrimive);

    boolean present_intPrimive = true;
    list.add(present_intPrimive);
    if (present_intPrimive)
      list.add(intPrimive);

    boolean present_longPrimive = true;
    list.add(present_longPrimive);
    if (present_longPrimive)
      list.add(longPrimive);

    boolean present_doublePrimive = true;
    list.add(present_doublePrimive);
    if (present_doublePrimive)
      list.add(doublePrimive);

    boolean present_stringObject = true && (isSetStringObject());
    list.add(present_stringObject);
    if (present_stringObject)
      list.add(stringObject);

    boolean present_byteArray = true && (isSetByteArray());
    list.add(present_byteArray);
    if (present_byteArray)
      list.add(byteArray);
  ...
  public int compareTo(BeanExample other) {
    ...
    lastComparison = Boolean.valueOf(isSetBooleanPrimive()).compareTo(other.isSetBooleanPrimive());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetBytePrimive()).compareTo(other.isSetBytePrimive());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBytePrimive()) {
    ...
    lastComparison = Boolean.valueOf(isSetShortPrimive()).compareTo(other.isSetShortPrimive());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetIntPrimive()).compareTo(other.isSetIntPrimive());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIntPrimive()) {
    ...
    lastComparison = Boolean.valueOf(isSetLongPrimive()).compareTo(other.isSetLongPrimive());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLongPrimive()) {
    ...
    lastComparison = Boolean.valueOf(isSetDoublePrimive()).compareTo(other.isSetDoublePrimive());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetStringObject()).compareTo(other.isSetStringObject());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetByteArray()).compareTo(other.isSetByteArray());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetByteArray()) {
