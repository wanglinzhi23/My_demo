...
@Entity
@Table(name = GlobalConsts.T_NAME_OTHER_DETAIL,schema=GlobalConsts.INTELLIF_STATIC)
public class OtherDetail extends InfoBase implements Serializable {

	private static final long serialVersionUID = 740789228431686808L;

	private static Logger LOG = LogManager.getLogger(OtherDetail.class);

	  public OtherDetail(String imageUrl,long id){
			this.id = id;
