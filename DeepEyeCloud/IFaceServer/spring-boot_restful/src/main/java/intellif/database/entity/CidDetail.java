...
@Entity
@Table(name = GlobalConsts.T_NAME_CID_DETAIL,schema=GlobalConsts.INTELLIF_STATIC)
public class CidDetail extends InfoBase implements Serializable {

	private static final long serialVersionUID = -4126491218133521061L;
    
	private static Logger LOG = LogManager.getLogger(CidDetail.class);
	
	public CidDetail(){
		
	}
	public CidDetail(String imageUrl,long id){
		this.id = id;
...
//		}
	...
	public String getCidImageBase64() {
		try {
			imageBase64 = FileUtil.GetImageStr(getImageData());
		} catch (Exception e) {
			LOG.error(e.toString());
