 ...
 */
@Entity
@Table(name = GlobalConsts.T_NAME_CID_INFO,schema=GlobalConsts.INTELLIF_STATIC)
//Notice: RMI object should be Serializable.
public class CidInfo extends InfoBase implements Serializable {

	private static final long serialVersionUID = -2935079401470769534L;

	private static Logger LOG = LogManager.getLogger(CidInfo.class);
