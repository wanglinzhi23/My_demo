...
public class ImageSearcherFactory {
     ...
     * @return
     */
    public static ImageSearcher createIFACEFImageSearcher(int maximumHits) {
        return new GenericFastImageSearcher(maximumHits, IFACEF.class, DocumentBuilder.FIELD_NAME_IFACEF);
    }
