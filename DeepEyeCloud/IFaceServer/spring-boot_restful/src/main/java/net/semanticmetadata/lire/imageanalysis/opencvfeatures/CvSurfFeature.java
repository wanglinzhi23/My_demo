 ...
 */
public class CvSurfFeature implements Serializable, LireFeature {
    public float angle;
    public int class_id;
    public int octave;
    public double[] point;
    ...
    public CvSurfFeature(float ang, int cl, int o, double[] pt, float res, float s, double[] feat) {
        angle = ang;
        class_id = cl;
        octave = o;
        point = pt;
    ...
    public float getDistance(LireFeature f) {
        ...
        return (float) MetricsUtils.distL2(feature, ((CvSurfFeature) f).feature);
    }
